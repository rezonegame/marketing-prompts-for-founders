...
3. **Next command**: → `/marketing:write` to draft your first SEO page, → `/marketing:content` to align your keyword plan with a content calendar, → `/marketing:audit` to check existing pages, or → `/marketing:llm-seo` (make AI engines recommend you)
